...
export class ChatbotService {
  ...
  async handleMessage(
    ...
    this.logger.log(`Mensagem recebida do usuário ${userId} (${userProfile}): "${userMessage}"`);
    ...
    try {
      ...
      // Use 'unknown' para capturar o erro e tratar de forma segura
      this.logger.error('Erro ao chamar a API da LLM:', (error as Error).message);
      return {
        assistantMessage:
